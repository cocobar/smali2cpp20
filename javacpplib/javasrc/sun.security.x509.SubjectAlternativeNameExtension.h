...
public:
	...
	static std::shared_ptr<java::lang::String> SUBJECT_NAME;
	std::shared_ptr<sun::security::x509::GeneralNames> names;
	SubjectAlternativeNameExtension();
	SubjectAlternativeNameExtension(std::shared_ptr<java::lang::Boolean> critical,std::shared_ptr<java::lang::Object> value);
	SubjectAlternativeNameExtension(std::shared_ptr<java::lang::Boolean> critical,std::shared_ptr<sun::security::x509::GeneralNames> names);
	SubjectAlternativeNameExtension(std::shared_ptr<sun::security::x509::GeneralNames> names);
