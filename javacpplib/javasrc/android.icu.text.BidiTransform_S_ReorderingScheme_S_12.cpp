// CPP L:\smali2cpp20\x64\Release\out\android\icu\text\BidiTransform$ReorderingScheme$12.smali
#include "java2ctype.h"
#include "android.icu.text.BidiTransform_S_Order.h"
#include "android.icu.text.BidiTransform_S_ReorderingScheme_S_12.h"
#include "android.icu.text.BidiTransform_S_ReorderingScheme.h"
#include "android.icu.text.BidiTransform.h"
#include "java.lang.String.h"

// .method constructor <init>(Ljava/lang/String;I)V
android::icu::text::BidiTransform_S_ReorderingScheme_S_12::BidiTransform_S_ReorderingScheme_S_12(std::shared_ptr<java::lang::String> var0,int var1)
{
...
void android::icu::text::BidiTransform_S_ReorderingScheme_S_12::doTransform(std::shared_ptr<android::icu::text::BidiTransform> transform)
{
...
bool android::icu::text::BidiTransform_S_ReorderingScheme_S_12::matches(unsigned char inLevel,std::shared_ptr<android::icu::text::BidiTransform_S_Order> inOrder,unsigned char outLevel,std::shared_ptr<android::icu::text::BidiTransform_S_Order> outOrder)
{
