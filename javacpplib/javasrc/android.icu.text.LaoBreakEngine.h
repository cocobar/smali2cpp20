#ifndef __android_icu_text_LaoBreakEngine__
#define __android_icu_text_LaoBreakEngine__
// H L:\smali2cpp20\x64\Release\out\android\icu\text\LaoBreakEngine.smali
...
class LaoBreakEngine : public android::icu::text::DictionaryBreakEngine {
protected:
private:
	static unsigned char LAO_LOOKAHEAD;
	static unsigned char LAO_MIN_WORD;
	static unsigned char LAO_PREFIX_COMBINE_THRESHOLD;
	static unsigned char LAO_ROOT_COMBINE_THRESHOLD;
	...
	static std::shared_ptr<android::icu::text::UnicodeSet> fLaoWordSet;
...
private:
	...
	public:
		static_init_class(){
			android::icu::text::LaoBreakEngine::static_cinit();
		}
	};
...
#endif //__android_icu_text_LaoBreakEngine__
