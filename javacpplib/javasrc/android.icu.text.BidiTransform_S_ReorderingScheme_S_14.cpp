// CPP L:\smali2cpp20\x64\Release\out\android\icu\text\BidiTransform$ReorderingScheme$14.smali
#include "java2ctype.h"
#include "android.icu.text.BidiTransform_S_Order.h"
#include "android.icu.text.BidiTransform_S_ReorderingScheme_S_14.h"
#include "android.icu.text.BidiTransform_S_ReorderingScheme.h"
#include "android.icu.text.BidiTransform.h"
#include "java.lang.String.h"

// .method constructor <init>(Ljava/lang/String;I)V
android::icu::text::BidiTransform_S_ReorderingScheme_S_14::BidiTransform_S_ReorderingScheme_S_14(std::shared_ptr<java::lang::String> var0,int var1)
{
...
void android::icu::text::BidiTransform_S_ReorderingScheme_S_14::doTransform(std::shared_ptr<android::icu::text::BidiTransform> transform)
{
	...
	android::icu::text::BidiTransform::-wrap8(transform, 0x4, cVar0);
	return;

}
// .method matches(BLandroid/icu/text/BidiTransform$Order;BLandroid/icu/text/BidiTransform$Order;)Z
bool android::icu::text::BidiTransform_S_ReorderingScheme_S_14::matches(unsigned char inLevel,std::shared_ptr<android::icu::text::BidiTransform_S_Order> inOrder,unsigned char outLevel,std::shared_ptr<android::icu::text::BidiTransform_S_Order> outOrder)
{
