...
template <typename K,typename V>
sun::util::locale::LocaleObjectCache_S_CacheEntry<K,V>::LocaleObjectCache_S_CacheEntry(std::shared_ptr<K> key,std::shared_ptr<V> value,std::shared_ptr<java::lang::ref::ReferenceQueue<V>> queue)
{
...
template <typename K,typename V>
std::shared_ptr<K> sun::util::locale::LocaleObjectCache_S_CacheEntry<K,V>::getKey()
{
