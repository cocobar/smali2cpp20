#ifndef __android_icu_impl_Norm2AllModes_S_DecomposeNormalizer2__
#define __android_icu_impl_Norm2AllModes_S_DecomposeNormalizer2__
// H L:\smali2cpp20\x64\Release\out\android\icu\impl\Norm2AllModes$DecomposeNormalizer2.smali
...
class Norm2AllModes_S_DecomposeNormalizer2 : public android::icu::impl::Norm2AllModes_S_Normalizer2WithImpl {
protected:
...
private:
public:
	Norm2AllModes_S_DecomposeNormalizer2(std::shared_ptr<android::icu::impl::Normalizer2Impl> ni);
...
public:
	virtual ~Norm2AllModes_S_DecomposeNormalizer2(){
	}

}; // class Norm2AllModes_S_DecomposeNormalizer2
}; // namespace android::icu::impl

#endif //__android_icu_impl_Norm2AllModes_S_DecomposeNormalizer2__
