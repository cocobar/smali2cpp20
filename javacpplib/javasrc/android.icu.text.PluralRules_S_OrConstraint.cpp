// CPP L:\smali2cpp20\x64\Release\out\android\icu\text\PluralRules$OrConstraint.smali
...
static android::icu::text::PluralRules_S_OrConstraint::serialVersionUID = 0x13814c681722a76eL;
// .method constructor <init>(Landroid/icu/text/PluralRules$Constraint;Landroid/icu/text/PluralRules$Constraint;)V
android::icu::text::PluralRules_S_OrConstraint::PluralRules_S_OrConstraint(std::shared_ptr<android::icu::text::PluralRules_S_Constraint> a,std::shared_ptr<android::icu::text::PluralRules_S_Constraint> b)
{
...
bool android::icu::text::PluralRules_S_OrConstraint::isFulfilled(std::shared_ptr<android::icu::text::PluralRules_S_FixedDecimal> n)
{
...
bool android::icu::text::PluralRules_S_OrConstraint::isLimited(std::shared_ptr<android::icu::text::PluralRules_S_SampleType> sampleType)
{
...
std::shared_ptr<java::lang::String> android::icu::text::PluralRules_S_OrConstraint::toString()
{
	
	std::shared_ptr<java::lang::StringBuilder> cVar0;
	
	cVar0 = std::make_shared<java::lang::StringBuilder>();
	return cVar0->append(this->a->toString())->append(std::make_shared<java::lang::String>(std::make_shared<char[]>(" or ")))->append(this->b->toString())->toString();
