// CPP L:\smali2cpp20\x64\Release\out\android\icu\text\UppercaseTransliterator.smali
...
static android::icu::text::UppercaseTransliterator::_ID = std::make_shared<java::lang::String>("Any-Upper");
// .method static synthetic -get0(Landroid/icu/text/UppercaseTransliterator;)Landroid/icu/util/ULocale;
std::shared_ptr<android::icu::util::ULocale> android::icu::text::UppercaseTransliterator::_get0(std::shared_ptr<android::icu::text::UppercaseTransliterator> _this)
{
	
	//    .param p0, "-this"    # Landroid/icu/text/UppercaseTransliterator;
	return _this->locale;

}
// .method public constructor <init>(Landroid/icu/util/ULocale;)V
android::icu::text::UppercaseTransliterator::UppercaseTransliterator(std::shared_ptr<android::icu::util::ULocale> loc)
{
	...
	cVar0 = 0x0;
	android::icu::text::Transliterator::(std::make_shared<java::lang::String>(std::make_shared<char[]>("Any-Upper")), cVar0);
...
void android::icu::text::UppercaseTransliterator::register()
{
	
	std::shared_ptr<android::icu::text::UppercaseTransliterator_S_1> cVar0;
	
	cVar0 = std::make_shared<android::icu::text::UppercaseTransliterator_S_1>();
	android::icu::text::Transliterator::registerFactory(std::make_shared<java::lang::String>(std::make_shared<char[]>("Any-Upper")), cVar0);
	return;
...
void android::icu::text::UppercaseTransliterator::addSourceTargetSet(std::shared_ptr<android::icu::text::UnicodeSet> inputFilter,std::shared_ptr<android::icu::text::UnicodeSet> sourceSet,std::shared_ptr<android::icu::text::UnicodeSet> targetSet)
{
	
	std::shared_ptr<android::icu::text::SourceTargetUtility> cVar0;
	std::shared_ptr<android::icu::text::UppercaseTransliterator_S_2> cVar1;
	...
	if ( this->sourceTargetUtility )     
		goto label_cond_11;
	cVar1 = std::make_shared<android::icu::text::UppercaseTransliterator_S_2>(this);
...
void android::icu::text::UppercaseTransliterator::handleTransliterate(std::shared_ptr<android::icu::text::Replaceable> text,std::shared_ptr<android::icu::text::Transliterator_S_Position> offsets,bool isIncremental)
{
...
label_goto_71:
	...
	goto label_goto_31;
	// 333    .end local v0    # "c":I
	// 334    .end local v1    # "delta":I
label_catchall_7e:
	// move-exception
