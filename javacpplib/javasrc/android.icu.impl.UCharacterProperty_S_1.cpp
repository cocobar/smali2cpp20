// CPP L:\smali2cpp20\x64\Release\out\android\icu\impl\UCharacterProperty$1.smali
...
android::icu::impl::UCharacterProperty_S_1::UCharacterProperty_S_1(std::shared_ptr<android::icu::impl::UCharacterProperty> this_S_0,std::shared_ptr<android::icu::impl::UCharacterProperty> this_S_0_1,int _S_anonymous0)
{
...
// .method contains(I)Z
bool android::icu::impl::UCharacterProperty_S_1::contains(int c)
{
	
	//    .param p1, "c"    # I
	return android::icu::impl::UBiDiProps::INSTANCE->isBidiControl(c);
