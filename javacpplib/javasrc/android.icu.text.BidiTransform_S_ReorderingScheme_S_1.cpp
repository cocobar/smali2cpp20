// CPP L:\smali2cpp20\x64\Release\out\android\icu\text\BidiTransform$ReorderingScheme$1.smali
#include "java2ctype.h"
#include "android.icu.text.BidiTransform_S_Order.h"
#include "android.icu.text.BidiTransform_S_ReorderingScheme_S_1.h"
#include "android.icu.text.BidiTransform_S_ReorderingScheme.h"
#include "android.icu.text.BidiTransform.h"
#include "java.lang.String.h"

// .method constructor <init>(Ljava/lang/String;I)V
android::icu::text::BidiTransform_S_ReorderingScheme_S_1::BidiTransform_S_ReorderingScheme_S_1(std::shared_ptr<java::lang::String> var0,int var1)
{
...
void android::icu::text::BidiTransform_S_ReorderingScheme_S_1::doTransform(std::shared_ptr<android::icu::text::BidiTransform> transform)
{
...
bool android::icu::text::BidiTransform_S_ReorderingScheme_S_1::matches(unsigned char inLevel,std::shared_ptr<android::icu::text::BidiTransform_S_Order> inOrder,unsigned char outLevel,std::shared_ptr<android::icu::text::BidiTransform_S_Order> outOrder)
{
