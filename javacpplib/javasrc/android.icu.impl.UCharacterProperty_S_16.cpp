// CPP L:\smali2cpp20\x64\Release\out\android\icu\impl\UCharacterProperty$16.smali
...
android::icu::impl::UCharacterProperty_S_16::UCharacterProperty_S_16(std::shared_ptr<android::icu::impl::UCharacterProperty> this_S_0,std::shared_ptr<android::icu::impl::UCharacterProperty> this_S_0_1)
{
...
// .method getValue(I)I
int android::icu::impl::UCharacterProperty_S_16::getValue(int c)
{
	
	//    .param p1, "c"    # I
	return android::icu::impl::UBiDiProps::INSTANCE->getJoiningGroup(c);
