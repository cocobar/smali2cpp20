...
public:
	...
	CertificateSubjectName(std::shared_ptr<java::io::InputStream> in);
	CertificateSubjectName(std::shared_ptr<sun::security::util::DerInputStream> in);
	CertificateSubjectName(std::shared_ptr<sun::security::x509::X500Name> name);
