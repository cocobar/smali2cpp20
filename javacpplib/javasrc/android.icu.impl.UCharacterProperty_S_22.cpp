// CPP L:\smali2cpp20\x64\Release\out\android\icu\impl\UCharacterProperty$22.smali
...
android::icu::impl::UCharacterProperty_S_22::UCharacterProperty_S_22(std::shared_ptr<android::icu::impl::UCharacterProperty> this_S_0,std::shared_ptr<android::icu::impl::UCharacterProperty> this_S_0_1,int _S_anonymous0)
{
...
// .method getValue(I)I
int android::icu::impl::UCharacterProperty_S_22::getValue(int c)
{
	
	//    .param p1, "c"    # I
	return ( android::icu::impl::Norm2AllModes::getNFCInstance({const[class].FS-Param})->impl->getFCD16(c) & 0xff);
