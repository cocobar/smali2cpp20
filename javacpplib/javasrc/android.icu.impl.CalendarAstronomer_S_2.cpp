// CPP L:\smali2cpp20\x64\Release\out\android\icu\impl\CalendarAstronomer$2.smali
...
android::icu::impl::CalendarAstronomer_S_2::CalendarAstronomer_S_2(std::shared_ptr<android::icu::impl::CalendarAstronomer> this_S_0)
{
...
std::shared_ptr<android::icu::impl::CalendarAstronomer_S_Equatorial> android::icu::impl::CalendarAstronomer_S_2::eval()
{
	
	return this->this_S_0->getSunPosition();
